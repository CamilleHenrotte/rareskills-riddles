...
describe("Viceroy", async function () {
    ...
    before(async function () {
        ...
        const VoterFactory = await ethers.getContractFactory("ApprovedVoter");
        voterContract = await VoterFactory.deploy();
        voterBytecode = VoterFactory.bytecode;
        await voterContract.deployed();

        const ViceroyFactory = await ethers.getContractFactory("Viceroy");
        viceroyContract = await ViceroyFactory.deploy();
        viceroyBytecode = ViceroyFactory.bytecode;
        await viceroyContract.deployed();
    ...
    it("conduct your attack here", async function () {
        await attacker.attack(governance.address, viceroyBytecode, voterBytecode);
    });
